...
/**
 * Validates resources, then gives official AgentSkills a sandbox whose listFiles
 * cannot follow a symlink or enumerate outside this skill. Other public sandbox
 * operations continue to use the Agent's real sandbox unchanged.
 */
